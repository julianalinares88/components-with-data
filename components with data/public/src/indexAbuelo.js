...
class AppContainer extends HTMLElement {
	...
	constructor() {
		...
		dataCards.forEach((element) => {
			...
			//Le indicamos que valores va a guardar sobre atributos especificos y ... 
			//se verifica que el dato exista para que si no lo hace cumpla la condicion de la card
			if (element.name) {
...
//Guarda la informacion en el shadow root
